...
export const DashboardPage = () => {
    ...
    return (
        <>
            ...
            <header className="py-3 mb-3 border-bottom bg-info">
                <div className="container-fluid d-grid gap-3 align-items-center"
                    ...
                    <div className="dropdown">
                        ...
                        <ul className="dropdown-menu text-small shadow" aria-labelledby="dropdownNavLink">
                            <li><a className="dropdown-item" href="#">Mostrar todos</a></li>
                            <li><a className="dropdown-item" href="#">Completados</a></li>
                            <li><a className="dropdown-item" href="#">En progreso</a></li>
                            <li>
                                <hr className="dropdown-divider"/>
                            </li>
                            <li><a className="dropdown-item" href="#">Crear nuevo</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <div className="flex-shrink-0 dropdown">
                            ...
                            <ul className="dropdown-menu text-small shadow" aria-labelledby="dropdownUser2">
                                ...
                                <li><a className="dropdown-item" href="#" onClick={onSubmit}>Cerrar sesion</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div className="container-fluid pb-3"  style={{
                height: '90%',
            }}>
